      ...
      { !!props.blue || !!props.red ?
        <div className="octagon">
          <div className="blue corner">
            <div className={["card", props.winner == props.blue.id ? "hey" : null, props.loser == props.blue.id ? "bye" : null].join(' ')}>
          ...
          <div className="red corner">
            <div className={["card", props.winner == props.red.id ? "hey" : null, props.loser == props.red.id ? "bye" : null].join(' ')}>
