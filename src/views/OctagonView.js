      ...
      { !!props.blue || !!props.red ?
        <div className="octagon">
          <div className="blue corner">
            <div className={["card", props.winner == props.blue.id ? "win" : null, props.loser == props.blue.id ? "loss" : null].join(' ')}>
          ...
          <div className="red corner">
            <div className={["card", props.winner == props.red.id ? "win" : null, props.loser == props.red.id ? "loss" : null].join(' ')}>
